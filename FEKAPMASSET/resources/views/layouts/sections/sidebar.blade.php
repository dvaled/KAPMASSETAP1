              ...
              <div class="px-8">
                  ...
                  <div accordion>
                    <div accordion-section class="mb-4 rounded-t-1">
                      <h5 class="mb-0">
                        <button section-trigger class="relative flex items-center w-full p-4 font-semibold text-left transition-all border-b border-solid cursor-pointer border-slate-100 ease-soft-in text-white rounded-t-1" aria-expanded="true">
                          Dashboard
...
//         dropdown.classList.add('max-h-full', 'opacity-100');
//     } else {
//         dropdown.classList.add('max-h-0', 'opacity-0');
//         dropdown.classList.remove('max-h-full', 'opacity-100');
//     }
// }
    </script>
