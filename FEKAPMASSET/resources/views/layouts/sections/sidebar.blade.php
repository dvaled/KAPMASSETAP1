                    ...
                    <li>
                      <h5 class="mb-0">
                        <button class="relative flex items-center w-full p-4 font-semibold text-left transition-all border-b border-solid cursor-pointer border-slate-100 ease-soft-in text-white rounded-t-1"
                          ...
                          <span class="text-sm ml-2">{{ $masters['description'] }}</span>
                          <i class="absolute right-0 pt-1 mr-4 leading-tight fa fa-plus text-xs"></i>
                          <i class="absolute right-0 hidden pt-1 mr-4 leading-tight fa fa-minus text-xs"></i>
                        </button>
                      </h5>
